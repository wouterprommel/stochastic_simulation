...
deviation1, std1 = convergence(1e6, 200)
deviation2, std2 = convergence(1e6, 200, method='orthogonal')
deviation3, std3 = convergence(1e6, 200, method='hypercube')
deviation4, std4 = convergence(1e6, 200, method='masking')
...
plt.plot(deviation4, label='$|A_{j,s} - A_{i,s}|$ (Masking sampling)', color=colors[3],  linestyle='-', alpha = 0.6)
